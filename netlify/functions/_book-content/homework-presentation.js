  ...
  return headers.map((header) => {
    ...
    return {
      ...
      items: homeworkItems.map((item) => ({
        ...
        componentSlug: item.component_slug || "",
  ...
  return [...homeworks.values()].map((homework) => {
    const items = [...homework.itemCandidates.values()].map((candidates) => {
      ...
      return {
        ...
        componentId: selected.component_id || null,
        componentSlug: selected.component_slug || "",
        componentTitle: selected.component_title || "",
        packageId: selected.package_id || null,
        packageSlug: selected.package_slug || "",

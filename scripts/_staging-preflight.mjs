...
export async function checkStagingDeployment(environment = process.env) {
  ...
  if (migrations.at(-1)?.filename !== "026_ultimate_b2_unit2_runtime_parity.sql") throw new Error("Production migration manifest must end at 026_ultimate_b2_unit2_runtime_parity.sql");

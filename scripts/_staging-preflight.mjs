...
export async function checkStagingDeployment(environment = process.env) {
  ...
  if (migrations.at(-1)?.filename !== "019_ultimate_b2_unit2_normalized_activities.sql") throw new Error("Production migration manifest must end at 019_ultimate_b2_unit2_normalized_activities.sql");

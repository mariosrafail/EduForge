...
try {
  ...
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 17$/);
  assert.equal(await page.locator(".legacy-page-location").count(), 0, "Page location pill must be removed");
  await page.getByRole("button", { name: "Next page" }).click();
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 18$/);
  ...
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 20-21$/);
  await page.getByRole("button", { name: "Unit overview" }).click();
  await page.locator('[data-page-ids="practice-31,practice-32"]').click();
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 31$/);
  await page.getByRole("button", { name: "Next page" }).click();
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 32$/);
  await page.getByRole("button", { name: "Unit overview" }).click();
  await page.locator('[data-page-ids="progress-check-33,progress-check-34"]').click();
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 33$/);
  await page.getByRole("button", { name: "Next page" }).click();
  assert.match(await page.locator(".legacy-page-heading strong").textContent(), /pg 34$/);
  await page.getByRole("button", { name: "Unit overview" }).click();
  await page.getByRole("button", { name: "Contents and exercises" }).click();

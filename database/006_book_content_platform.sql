...
join (
  values
    ...
    ('unit-2-listening', 'workbook-page-20-listening-exercise', 'Workbook page 20 Listening Exercise', 'listening_gap_fill', 'Listen to a man giving a guided tour of the River Thames in London and complete the sentences with a word or short phrase.', 10, null::int, null::text, '{"placeholder":true,"duration":"01:40","note":"Replace with supplied Ultimate B2 audio asset","demoActivityKey":"listening-page-20"}'::jsonb, '{}'::jsonb, 1, true),
    ...
    ('unit-2-grammar', 'exercise-4', 'Join the sentences', 'grammar_sentence_joining', 'Join the sentences. Use the past simple, the past continuous and the words in bold.', 12, null::int, null::text, '{"demoActivityKey":"grammar-ex4","grammar_rules":["Past simple","Past continuous","Used to"]}'::jsonb, '{}'::jsonb, 2, true),
...
with activity_seed(activity_slug, question_number, prompt, question_type, feedback_json, option_label, option_text, is_correct, sort_order) as (
  values
    ...
    ('workbook-page-20-listening-exercise', 1, 'Alex says that if they want to be warmer, people should go to the ___ part of the boat.', 'typed_gap_fill', '{"acceptedAnswers":["lower"]}'::jsonb, 'A', 'lower', true, 1),
    ('workbook-page-20-listening-exercise', 2, 'The river cruise will take ___ hours in total.', 'typed_gap_fill', '{"acceptedAnswers":["four","4"]}'::jsonb, 'A', 'four', true, 1),
    ('workbook-page-20-listening-exercise', 3, 'A River Pass allows tourists to get off the boat in the ___.', 'typed_gap_fill', '{"acceptedAnswers":["city centre","city center"]}'::jsonb, 'A', 'city centre', true, 1),
    ('workbook-page-20-listening-exercise', 4, 'Roman invaders built the first bridge across the Thames ___ ago.', 'typed_gap_fill', '{"acceptedAnswers":["2000 years","2,000 years"]}'::jsonb, 'A', '2000 years', true, 1),
    ('workbook-page-20-listening-exercise', 5, 'Long ago, many sections of the river would ___ over completely in winter.', 'typed_gap_fill', '{"acceptedAnswers":["freeze"]}'::jsonb, 'A', 'freeze', true, 1),
    ('workbook-page-20-listening-exercise', 6, 'During ''Frost Fairs'', dancing and ___ took place on the ice.', 'typed_gap_fill', '{"acceptedAnswers":["sports"]}'::jsonb, 'A', 'sports', true, 1),
    ('workbook-page-20-listening-exercise', 7, 'In the 1950s, the Thames was said to be a ___ river.', 'typed_gap_fill', '{"acceptedAnswers":["dead"]}'::jsonb, 'A', 'dead', true, 1),
    ('workbook-page-20-listening-exercise', 8, 'Alex explains that now, even ___ occasionally swim up the river.', 'typed_gap_fill', '{"acceptedAnswers":["sharks"]}'::jsonb, 'A', 'sharks', true, 1),
    ('workbook-page-20-listening-exercise', 9, 'The movement of sea water can sometimes cause ___ in London.', 'typed_gap_fill', '{"acceptedAnswers":["floods"]}'::jsonb, 'A', 'floods', true, 1),
    ('workbook-page-20-listening-exercise', 10, 'Annually, ___ million tourists ride on the London Eye.', 'typed_gap_fill', '{"acceptedAnswers":["3.5","three point five"]}'::jsonb, 'A', '3.5', true, 1),
    ...
    ('exercise-4', 1, 'I woke up this morning. It was snowing. when', 'typed_sentence_joining', '{"acceptedAnswers":["When I woke up this morning, it was snowing."]}'::jsonb, 'A', 'When I woke up this morning, it was snowing.', true, 1),
    ('exercise-4', 2, 'I was studying. I suddenly felt sleepy. while', 'typed_sentence_joining', '{"acceptedAnswers":["While I was studying, I suddenly felt sleepy."]}'::jsonb, 'A', 'While I was studying, I suddenly felt sleepy.', true, 1),
    ('exercise-4', 3, 'I was walking home. I ran into a friend of mine. as', 'typed_sentence_joining', '{"acceptedAnswers":["As I was walking home, I ran into a friend of mine."]}'::jsonb, 'A', 'As I was walking home, I ran into a friend of mine.', true, 1),
    ('exercise-4', 4, 'I made the final decision. I felt a lot more relaxed. as soon as', 'typed_sentence_joining', '{"acceptedAnswers":["As soon as I made the final decision, I felt a lot more relaxed."]}'::jsonb, 'A', 'As soon as I made the final decision, I felt a lot more relaxed.', true, 1),
    ('exercise-4', 5, 'I heard him come in. We were having dinner. while', 'typed_sentence_joining', '{"acceptedAnswers":["I heard him come in while we were having dinner."]}'::jsonb, 'A', 'I heard him come in while we were having dinner.', true, 1),
    ('exercise-4', 6, 'We were packing for our trip. The power went off. when', 'typed_sentence_joining', '{"acceptedAnswers":["We were packing for our trip when the power went off."]}'::jsonb, 'A', 'We were packing for our trip when the power went off.', true, 1),

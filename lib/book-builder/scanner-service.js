...
async function persistProjectFiles(projectDirectory, project, binding, scan, resolution, { expectedRevision } = {}) {
  ...
  if (scan.profileResult) {
    ...
    const files = new Map([
      ...
      ["iwb-schema-summary.json", "iwbSchemaSummary"], ["structure-candidates.json", "structureCandidates"], ["component-hierarchy.json", "componentHierarchy"], ["page-candidates.json", "pageCandidates"],

...
export async function runUltimateProfile({ resolution, inventory, repositoryRoot, concurrency = 8 }) {
  ...
  const reviews = [
    ...
    ...pages.reviewItems, ...menu.reviewItems, ...atlases.reviewItems, ...hotspots.reviewItems, ...media.reviewItems,
  ];

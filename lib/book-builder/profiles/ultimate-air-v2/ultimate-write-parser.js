...
export function parseWriteResponses({ xml, activityCandidateId, sourceRelativePath, sourceSha256, provenAlternativeDelimiter = null, nestedIdAllocator = null }) {
  ...
  const responseFieldIds = allocateNestedCandidateIds("response", activityCandidateId, fields, (field) => field?.["@_id"], "text", {
    ...
    sourceRelativePath,
    structuralPosition: (index) => `text[${index + 1}]`,
  });

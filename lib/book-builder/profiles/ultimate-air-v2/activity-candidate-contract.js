...
export function allocateNestedCandidateIds(prefix, parentId, items, publisherIdentity, fallbackPrefix) {
  ...
  return identities.map((identity) => {
    ...
    return nestedCandidateId(prefix, parentId, uniqueIdentity);
  });
}

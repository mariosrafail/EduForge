...
export const REVIEW_REASON_CODES = new Set([
  ...
  "raster_target_label_missing", "raster_response_prompt_missing",
...
export function createReviewItem({ category, severity = "warning", locator = ".", dependencyFactIds = [], reasonCode, explanation, suggestedDecisionKind = null, targetId = null, activityCandidateId = null, evidence = [], blocking = false }) {
  ...
  return {
    ...
    ...(targetId ? { targetId: String(targetId) } : {}), ...(activityCandidateId ? { activityCandidateId: String(activityCandidateId) } : {}),

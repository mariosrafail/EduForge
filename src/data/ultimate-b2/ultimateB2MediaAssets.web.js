export const ultimateB2ReadingVideo = { logicalKey: "ultimate-b2.students-book.unit-2.reading.video-intro", localUrl: null, devFallbackUrl: import.meta.env.DEV ? "/src/assets/books/ultimate-b2/media/unit_2_reading_video.mp4" : null };
export const ultimateB2ReadingAudio = { logicalKey: "ultimate-b2.students-book.unit-2.reading.text-audio", localUrl: null, devFallbackUrl: import.meta.env.DEV ? "/src/assets/books/ultimate-b2/media/unit_2_reading_on_a_fast_track.mp3" : null };

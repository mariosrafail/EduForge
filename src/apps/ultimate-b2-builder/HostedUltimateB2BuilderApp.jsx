...
function ActivityReview({ nativeActivities, bookSlug, componentSlug }) {
  ...
  return <main className="activity-builder-shell b2-hosted-activity-review">
    ...
    {!managed ? <UnitExtrasEditor open={Boolean(extrasUnit)} unit={extrasUnit?.unit} category={extrasUnit?.category} onClose={() => setExtrasUnit(null)} returnFocusRef={extrasTriggerRef} /> : null}

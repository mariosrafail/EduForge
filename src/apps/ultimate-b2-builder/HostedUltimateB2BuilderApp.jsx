...
function ActivityReview({ nativeActivities }) {
  ...
  return <main className="activity-builder-shell b2-hosted-activity-review">
    ...
    <UnitExtrasEditor open={Boolean(extrasUnit)} unit={extrasUnit} onClose={() => setExtrasUnit(null)} returnFocusRef={extrasTriggerRef} />
    ...
    <div className={`b2-hosted-activity-layout ${navigationExpanded ? "is-navigation-expanded" : "is-navigation-collapsed"}`} data-navigation-expanded={navigationExpanded}>
      ...
      <aside id="activity-builder-book-navigation" className="activity-builder-sidebar" aria-label="Activity Builder book navigation">
        ...
        <ActivityTree {...{ filtered, expandedUnits, expandedPages, selectedId, selectActivity, toggleSet, setExpandedUnits, setExpandedPages }} onOpenExtras={(nextUnit, trigger) => { extrasTriggerRef.current = trigger; setExtrasUnit(nextUnit); }} />
      </aside>
...
function ActivityTree({ filtered, expandedUnits, expandedPages, selectedId, selectActivity, toggleSet, setExpandedUnits, setExpandedPages, onOpenExtras }) {

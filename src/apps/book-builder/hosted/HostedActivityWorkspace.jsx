...
export function HostedActivityWorkspace({
  ...
  return <main className="activity-builder-shell b2-hosted-activity-review">
    ...
    {!managed && UnitExtras ? <UnitExtras open={Boolean(extrasUnit)} unit={extrasUnit?.unit} category={extrasUnit?.category} onClose={() => setExtrasUnit(null)} returnFocusRef={extrasTriggerRef} /> : null}

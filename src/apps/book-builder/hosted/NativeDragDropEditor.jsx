  ...
  return <section className="native-activity-foundation native-drag-drop-editor studio-editor">
    ...
    {tab === "content" ? <div className="studio-content-panel native-drag-drop-content">
      ...
      <fieldset className="native-drag-drop-layout-settings"><legend>Activity layout</legend>
        ...
        <p>{interaction.layoutMode === "text" ? "The managed text image scrolls above the phrase bank. Students drag only stable A/B/… labels; text-mode items are always consumed and cannot be reusable." : "The visual canvas sits above a separately scrolling answer bank when a pixel height is configured."}</p>

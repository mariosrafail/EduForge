  ...
  const uploadArtwork = async (file) => {
    ...
    try {
      ...
      mutatePublic((next) => {
        ...
        next.parts[0].interaction.artwork.push({ id: artworkId, assetSlot: slot, area: { x: 160, y: 120, width: 320, height: 220 }, order: next.parts[0].interaction.artwork.length, altText: "", decorative: false, fit: "contain", locked: false });
      });

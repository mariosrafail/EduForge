      ...
      <section className="studio-teacher-projects" aria-labelledby="teacher-projects-title">
        ...
        {teacherProjects.projects.length ? <div className="studio-project-grid">{teacherProjects.projects.map((project) => (
          <article className="studio-project-card" key={project.projectId}>
            ...
            <dl className="studio-project-facts"><div><dt>Revision</dt><dd>{project.revision}</dd></div><div><dt>Assets</dt><dd>{project.assetCount}</dd></div><div><dt>Shell</dt><dd>{project.completeness.configuredCount} / {project.completeness.requiredCount}</dd></div><div><dt>Pages</dt><dd>{project.contentStatus.entryCount} entries</dd></div></dl><progress className="studio-teacher-project-progress" value={project.completeness.configuredCount} max={project.completeness.requiredCount} aria-label={`${project.displayName} shell completion`} />

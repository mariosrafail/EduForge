...
- `docs/legacy-assets/ultimate-b2/menu-branding.md`
- `docs/legacy-assets/ultimate-b2/contact-sheets/`

The full `.app`, SWFs, native executables, frameworks, source archives, the intro FLV, temporary extraction data, and textbook narration/listening/video are deliberately not committed. Only the five byte-exact entries needed from `logo_1.zip` are tracked; the archive itself is not.

...
const registry = Object.freeze({
  ...
  "complete-sentences": definition("complete-sentences", normalizeNativeCompleteSentencesInteraction, normalizeNativeCompleteSentencesSolution, () => ({ kind: "complete-sentences", items: [], presentation: { kind: "image-hotspot", panels: [{ id: "panel-00000000000000000000000000000001", backgroundAssetSlot: "", sourceWidth: 1024, sourceHeight: 582, hotspots: [] }] } }), () => ({ kind: "complete-sentences", answers: [] }), validateNativeCompleteSentencesTopology, assessNativeCompleteSentencesReadiness, true),
